...
public class BanqueMetierImpl implements IBanqueMetier{
	...
	public Compte updateCompte(Long id, Compte cm) {
		Compte compte = compteRepository.findById(id).get();
		compte.setDateCreation(cm.getDateCreation());
		compte.setSolde(cm.getSolde());
	    return compteRepository.save(compte);
	}
	
	public Client updateClient(Long id, Client cl) {
	...
	public void deleteCById(Long cpt)
    {
        compteRepository.deleteById(cpt);
    }
}
